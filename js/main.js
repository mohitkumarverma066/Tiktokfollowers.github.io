...
function FLICKSTATUS() {
  ...
  $(".tttmiddle").fadeOut(1250, function() {
    ...
    $(".tttleft").empty();
    $(".tttmiddle").empty();
    $(".tttleft").append('<img src="https://mohitkumarverma066.github.io/Tiktokfollowers.github.io/flags/1x1/' + rC + '.svg" class="flick-flag">');
    $(".tttmiddle").append('<h5 class="m-0"></span> ' + rIP + ' received <br><strong>' + rA + ' new likes</strong></h5>');
    $(".tttleft").fadeIn(1250);
...
function s_1() {
  ...
  if ($("#tiktok-name").val() != "" && $("#fans-select option:selected").val() != "") {
      ...
      bar.animate(FLI/100, function() {
        ...
        $("#loading2").html(L222).fadeIn(750, function() {
            ...
            bar.animate(FLI/100, function() {
              ...
              var L3 = 'Change likes value (+' + $("#fans-select option:selected").val() + ') in the TikTok database...';
    ...
    alert("Enter your username and choose how many likes you want.")
  }
